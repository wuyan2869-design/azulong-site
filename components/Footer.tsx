            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="text-gray-300 text-sm">sales@azulongparts.com</p>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className="text-gray-300 text-sm">+86 574 xxxx xxxx</p>
                    <p className="text-gray-400 text-xs">Global B2B Support</p>
                  </div>
                </div>
              </div>
